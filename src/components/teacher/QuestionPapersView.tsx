...
export const QuestionPapersView: React.FC = () => {
  ...
  const [papers, setPapers] = useState([
    { id: 'qp1', title: 'Grade 10 Mid-Term Math Paper A', questions: 5, topic: 'Linear Equations & Quadratics', status: 'Extracted', maxMarks: 50 },
    { id: 'qp2', title: 'Unit 2 Slip Test - Algebraic Simplification', questions: 3, topic: 'Algebra', status: 'Extracted', maxMarks: 30 }
  ]);
              ...
              <div className="space-y-3">
                <div className="p-4 bg-[#FDFCF8] rounded-xl border border-[#E0DED7] space-y-2">
                  <div className="flex items-center justify-between text-xs">
                    <span className="font-bold text-[#2D4A3E]">Question 1 (10 Marks)</span>
                    <span className="px-2 py-0.5 bg-[#EAF0E8] text-[#1E3A2B] rounded-md font-semibold">Linear Equation</span>
                  </div>
                  <p className="text-sm font-bold text-[#222521]">Solve for x: 2x + 5 = 15</p>
                  <div className="p-2.5 bg-[#F4F2EC] rounded-lg text-xs space-y-1 text-[#545850]">
                    <p className="font-semibold text-[#222521]">Rubric Criteria:</p>
                    <p>• Transcribe equation correctly: 3 marks</p>
                    <p>• Isolate 2x term (2x = 10): 4 marks</p>
                    <p>• Final division (x = 5): 3 marks</p>
                  </div>
                </div>

                <div className="p-4 bg-[#FDFCF8] rounded-xl border border-[#E0DED7] space-y-2">
                  <div className="flex items-center justify-between text-xs">
                    <span className="font-bold text-[#2D4A3E]">Question 2 (10 Marks)</span>
                    <span className="px-2 py-0.5 bg-[#EAF0E8] text-[#1E3A2B] rounded-md font-semibold">Algebraic Expansion</span>
                  </div>
                  <p className="text-sm font-bold text-[#222521]">Simplify the expression: -(2x - 5) + 3x</p>
                  <div className="p-2.5 bg-[#F4F2EC] rounded-lg text-xs space-y-1 text-[#545850]">
                    <p className="font-semibold text-[#222521]">Rubric Criteria:</p>
                    <p>• Distribute negative sign (-2x + 5): 5 marks</p>
                    <p>• Combine like terms (x + 5): 5 marks</p>
                  </div>
                </div>
              </div>
            </div>
